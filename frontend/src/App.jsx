...
function App() {
  ...
  if (isAdminPage) {
    return <OperationsPanel apiUrl={API_URL} />
  }
...
function WheelApp() {
  ...
  const verifyCode = async (e) => {
    ...
    try {
      ...
      const selectedWheel = data.configuration
        ...
        wheel && (
          <section className="wheel-page">
            ...
            <div className="wheel-status-strip" aria-hidden="true">
              ...
              <span>
                PRIZE MATRIX {String(wheel.prizes.length).padStart(2, '0')}
              </span>
            </div>

            <div
              className={`wheel-area ${spinning ? 'is-spinning' : ''}`}
              aria-label={`Ruota ${wheel.name}`}
            >

              <div className="wheel-tech-ring" aria-hidden="true" />
              ...
              <div className="wheel-hud wheel-hud-right" aria-hidden="true">
                <small>LUCK</small>
                <strong>MAX</strong>
              </div>
            ...
            <div className="wheel-actions">
              ...
              <div className={`spin-meter ${spinning ? 'is-active' : ''}`} aria-hidden="true">
                <span />
              </div>
                      ...
                      >
                        ...
                        <td data-label="AZIONI">
                          ...
                          <button
                            ...
                            aria-label={`Copia il codice ${item.code}`}
                            onClick={() =>
                              copyCode(
                                item.code
                              )
